...
public class AbstractDispatcherServletTest implements
    AfterRunService {
    ...
    public AfterRunService runService(String requestUri, String method)
    ...
    public void closeServletContext() {
        if (this.dispatcherServlet != null) {
            ((ConfigurableWebApplicationContext) dispatcherServlet.getWebApplicationContext()).close();
        }
    }
}
